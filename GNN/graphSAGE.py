...
#https://github.com/hoopoes/pytorch-gnn-research/blob/main/graphsage/graphsage.ipynb

#GCN 
# non-Euclidean domains, spatial model - graphSage

#1) graphSAGE using pytorch geometric
#참조 https://github.com/hoopoes/pytorch-gnn-research/blob/main/graphsage/graphsage.ipynb
...
#Data(x=[232965, 602], edge_index=[2, 114615892], y=[232965], 
# train_mask=[232965], val_mask=[232965], test_mask=[232965]) / edge 평균 4000, node degree
...
print(f"현재 Subgraph에서 사용된 모든 node id의 개수: {n_id.shape[0]}")
...
print(f"진행 방향: {B}개의 2-hop neighbors ->"
